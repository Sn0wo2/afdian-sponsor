...
func GetConfig() *Config {
	...
	return &Config{
		...
		AvatarSize:    getEnv("AFDIAN_AVATAR_SIZE", 150, strconv.Atoi, func(v int) bool { return v > 0 }),
		Margin:        getEnv("AFDIAN_MARGIN", 20, strconv.Atoi, func(v int) bool { return v != 0 }),
